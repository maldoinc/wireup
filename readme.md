...
> [!IMPORTANT]
> **🚀 Wireup Preview:** API improvements focused on clearer naming, explicit abstraction binding, and first-class support for protocols.
>
> Follow the progress in **[PR #100](https://github.com/maldoinc/wireup/pull/100)**.
